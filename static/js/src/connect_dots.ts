...
class ConnectDotsEditor {
    ...
    private pendingDot: Dot | null = null;
    
    private boardForm: HTMLFormElement;
    ...
    private colorStatus: HTMLDivElement;
    private gridContainer: HTMLDivElement;
    private boardGrid: HTMLDivElement;
    private csrf: string;
    
    constructor(initialBoard: BoardState | null) {
        ...
        this.boardForm = boardForm as HTMLFormElement;
        this.titleInput = titleInput as HTMLInputElement;
        this.rowsInput = rowsInput as HTMLInputElement;
        this.colsInput = colsInput as HTMLInputElement;
        ...
        this.colorPicker = colorPicker as HTMLDivElement;
        this.colorStatus = colorStatus as HTMLDivElement;
    ...
    private handleGenerateGrid(): void {
